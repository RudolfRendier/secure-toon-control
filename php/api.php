...
$PASSWORD_VERSION = %%password_version%%; // INCREASE WHEN NEW PASSWORD (ALSO CHANGE IN INDEX.PHP)
$ADRESS = '%%toon_ip%%'; // LOCAL IP ADRESS OF TOON SERVER
$VERSION = '%%toon_version%%'; // TOON VERSION (SUPPORTED: 4.8 / 4.9)
